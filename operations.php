                            ...
                            <div class="card alert">
                                <div class="card-header pr">
                                    ...
                                    <div class="search-action">
                                        <a href="#"><button type="button" class="btn btn-primary m-b-10 m-l-5 addLine">Добавить операцию</button></a>
                                        <div class="search-type dib">
                                            <input class="form-control input-rounded itemDescription" placeholder="Поиск по описанию..." type="text">
                                        </div>
                                        <div class="search-type dib">
                                    ...
                                    <div class="card-header-right-icon">
                                        <ul>
                                            ...
                                            <li class="card-option drop-menu"><i class="ti-menu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" role="link"></i>
                                                <ul class="card-option-dropdown dropdown-menu ulItem">
                                                    <li class="itemAll"><a href="#">Все статьи</a></li>
                                                </ul>
                                            </li>
                                            <li class="card-option drop-menu"><i class="ti-credit-card" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" role="link"></i>
                                                <ul class="card-option-dropdown dropdown-menu ulInvoice">
                                                    <li class="invoiceAll"><a href="#">Все счета</a></li>
                                                </ul>
                                            </li>
                                            <li class="card-option drop-menu"><i class="ti-filter" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" role="link"></i>
                                                <ul class="card-option-dropdown dropdown-menu ulTypeTransaction">
                                                    <li class="liAllType"><a href="#"><i class="ti-infinite"></i>Все операции</a></li>
                                                    <li class="liArrival"><a href="#"><i class="ti-plus"></i>Приход</a></li>
                                                    <li class="liExpense"><a href="#"><i class="ti-minus"></i>Расход</a></li>
                                                    <li class="liTranslation"><a href="#"><i class="ti-reload"></i>Перевод</a></li>
                                                    <li class="liDebitCredit"><a href="#"><i class="ti-agenda"></i>Задолженность</a></li>
                                                    <li class="liWriteOff"><a href="#"><i class="ti-shopping-cart-full"></i>Товародвижение</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="table-responsive tableOrders">
                                        <table class="table student-data-table m-t-20 table-hover">
                                            ...
                                            <thead>
                                                <tr>
                                                    <th>Действие</th>
                                                    <th class='displayNone'>Номер операции</th>
                                                    <th>Дата</th>
                                                    <th>Операция</th>
                                                    <th>Статья</th>
                                                    <th>Описание</th>
                                                    <th>Контрагент</th>
                                                    <th>Счет</th>
                                                    <th class='displayNone'>Тип операции</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                            <?php
                                            $range = "SQL запросы!P1:W";
                                            ...
                                            if (empty($values)) {
                                                ...
                                                foreach ($values as $row) {
                                                    ...
                                                    echo "<td>" . $row[1] . "</td>";
                                                    if (stristr($row[2], '-') !== false) {
                                                        echo "<td class='color-danger'>" . $row[2] . "</td>";
                                                    } else {
                                                        echo "<td class='color-success'>" . $row[2] . "</td>";
                                                    }
                                                    echo "<td>" . $row[3] . "</td>";
                                                    echo "<td>" . $row[4] . "</td>";
                                                    echo "<td>" . $row[5] . "</td>";
                                                    echo "<td>" . $row[6] . "</td>";
                                                    echo "<td class='displayNone'>" . $row[7] . "</td>";
                                                }
...
?>
    ...
    <!-- scripit init-->
    <script src="assets/js/operations.js<?php require "version.php"; ?>"></script>
