...
<head>
    ...
    <title>Отчет по задолженностям</title>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-4 p-r-0 RemoveIndent">
                        <div class="page-header">
                            <div class="page-title">
                                <h1><a href="/help-debts.php" target="_blank"><i class="ti-agenda"></i> Как устроен этот отчет?</a></h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card alert">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive tableOrders tabDebt">
