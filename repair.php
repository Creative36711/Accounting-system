...
if (!isset($_COOKIE['stringsRepair'])) {
    setcookie("stringsRepair", 100);
    $_COOKIE['stringsRepair'] = 100;
}

if (!isset($_COOKIE['numLin024'])) {
    $_COOKIE['numLin024'] = 102;
}

$_COOKIE['stringsRepair'] = (int)$_COOKIE['numLin024'] - (int)$_COOKIE['stringsRepair'];
?>
                            ...
                            <div class="card alert">
                                <div class="card-header pr">
                                    ...
                                    <div class="search-action">
                                        ...
                                        <a href="/edit-repair.php"><button type="button" class="btn btn-primary m-b-10 m-l-5 addLine">Добавить заказ</button></a>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive tableOrders">
                                        <table class="table student-data-table m-t-20 table-hover">
                                            ...
                                            <tbody>
                                            <?php
                                            $range = "Ремонт!A" . $_COOKIE['stringsRepair'] . ":L";
                                            $range2 = "Ремонт!S1";
                                            ...
                                            if (empty($values)) {
                                                ...
                                                foreach ($values as $row) {
                                                    ...
                                                    echo "<td>" . $row[5] . "</td>";
                                                    echo "<td>" . $row[11] . ": " . $row[6] . "</td>";
                                                    echo "<td>" . $row[7] . "</td>";
                                                    echo "<td>" . $row[8] . "</td>";
                                                    if ($row[9] === "Сдан") {
                                                        echo "<td><span class='badge badge-success'>" . $row[9] . "</span></td>";
                                                    } else if ($row[9] === "Принят") {
                                                        echo "<td><span class='badge badge-danger'>" . $row[9] . "</span></td>";
                                                    } else if ($row[9] === "В работе") {
                                                        echo "<td><span class='badge badge-warning'>" . $row[9] . "</span></td>";
                                                    } else if ($row[9] === "Готов") {
                                                        echo "<td><span class='badge badge-primary'>" . $row[9] . "</span></td>";
                                                    } else if ($row[9] === "Возврат") {
                                                        echo "<td><span class='badge badge-warining'>" . $row[9] . "</span></td>";
                                                    }
                                                    if ($row[10] === "Оплата") {
                                                        echo "<td><span class='badge badge-success'>" . $row[10] . "</span></td>";
                                                    } else if ($row[10] === "Предоплата") {
                                                        echo "<td><span class='badge badge-primary'>" . $row[10] . "</span></td>";
                                                    } else if ($row[10] === "Без оплаты") {
                                                        echo "<td><span class='badge badge-warining'>" . $row[10] . "</span></td>";
                                                    } else if ($row[10] === "Не оплачен") {
                                                        echo "<td><span class='badge badge-danger'>" . $row[10] . "</span></td>";
                                                    }
                                                    echo "</tr>";
                                                }
                                                echo "<div class='numLin024 displayNone'>" . $values2[0][0] . "</div>";
                                            }
                                            ?>
                                            </tbody>
                                            </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="text" id="range_024" value="" name="range" />
            </div>
...
?>
    ...
    <!-- scripit init-->
    <script src="assets/js/repair.js<?php require "version.php"; ?>"></script>
    <!-- scripit init-->
