...
if (!isset($_COOKIE['stringsModel'])) {
    setcookie("stringsModel", 100);
    $_COOKIE['stringsModel'] = 100;
}

if (!isset($_COOKIE['numLin023'])) {
    $_COOKIE['numLin023'] = 150;
}


$_COOKIE['stringsModel'] = (int)$_COOKIE['numLin023'] - (int)$_COOKIE['stringsModel'];
?>
                            ...
                            <div class="card alert">
                                <div class="card-header pr">
                                    ...
                                    <div class="search-action searchModel">
                                        <a href="edit-model.php"><button type="button" class="btn btn-primary m-b-10 m-l-5">Добавить модель</button></a>
                                        <div class="search-type dib">
                                            <input class="form-control input-rounded" placeholder="Поиск по названию..." type="text">
                                        </div>
                                    </div>
                                        ...
                                        <table class="table student-data-table m-t-20 table-hover">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Пошив</th>
                                                    <th>Стоимость</th>
                                                    <th>Процент дизайнера</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                            <?php
                                            $range = "Модели!A" . $_COOKIE['stringsModel'] . ":G";
                                            $range2 = "Модели!J1";
                                            ...
                                            if (empty($values)) {
                                                ...
                                                echo "<div class='numLin023 displayNone'>" . $values2[0][0] . "</div>";
                                            }
                                            ?>
                                            </tbody>
                                            </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h4>Выберите количество строк, выгружаемых с сервера. Рекомендуемое количество - 100 строк.</h4>
                <input type="text" id="range_023" value="" name="range" />
            </div>
...
?>
    ...
    <!-- scripit init-->
    <script src="assets/js/model.js<?php require "version.php"; ?>"></script>
